...
namespace Planning.UnitTests
{
    public class CustomFixture : IDisposable
    {
        ...
        public CustomFixture()
        {
            ...
            serviceCollection.AddScoped<DB.Repository.IRepository<DB.Context.UserSettings>, DB.Repository.Repository<DB.Context.UserSettings>>();
            ...
            serviceCollection.AddScoped<DB.Repository.IRepository<DB.Context.Schedule>, DB.Repository.Repository<DB.Context.Schedule>>();

            serviceCollection.AddScoped<IProjectSelectService, ProjectSelectService>();
