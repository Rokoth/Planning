...
namespace Planning.DB.Repository
{
    ...
    public interface IRepository<T> where T : IEntity
    {
        ...
        Task<Contracts.Model.PagedResult<T>> GetAsync(Filter<T> filter, CancellationToken token);
        ...
        /// <param name="token">token</param>
        /// <returns>PagedResult<T></returns>
        Task<Contracts.Model.PagedResult<T>> GetAsyncDeleted(Filter<T> filter, CancellationToken token);
